...
hist(new_GPUs$Max_Power,xlab="Max_Power",ylab="Frequency",main="Histogram of Max_Power",xlim = c(0,800))
boxplot(new_GPUs$Max_Power, main = "Boxplot of Max_Power")

hist(new_GPUs$Memory,xlab="Memory",ylab="Frequency",main="Histogram of Memory",xlim = c(0,30000))
boxplot(new_GPUs$Memory, main = "Boxplot of Memory")

hist(new_GPUs$Memory_Bandwidth,xlab="Memory_Bandwidth",ylab="Frequency",main="Histogram of Memory_Bandwidth",xlim = c(0,1200))
boxplot(new_GPUs$Memory_Bandwidth, main = "Boxplot of Memory_Bandwidth")

hist(new_GPUs$Memory_Bus,xlab="Memory_Bus",ylab="Frequency",main="Histogram of Memory_Bus",xlim = c(0,8000))
boxplot(new_GPUs$Memory_Bus, main = "Boxplot of Memory_Bus")

hist(new_GPUs$Memory_Speed,xlab="Memory_Speed",ylab="Frequency",main="Histogram of Memory_Speed",xlim = c(0,2000))
boxplot(new_GPUs$Memory_Speed, main = "Boxplot of Memory_Speed")

hist(new_GPUs$Release_Date,xlab="Release_Date",ylab="Frequency",main="Histogram of Release_Date",xlim = c(0,2015))
boxplot(new_GPUs$Release_Date, main = "Boxplot of Release_Date")
